...
const imageSrc =
  ...
  <article class="product">
    ...
    <footer class="product__footer">
      ...
      <button id="newBuyButton" type="button" class="product__buy-button">Buy</button>
    </footer>
  </article>
`;

document.body.innerHTML += secondProductHTML;

const buyButton = document.querySelector('#newBuyButton');
